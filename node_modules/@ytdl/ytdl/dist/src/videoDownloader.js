...
var progressBar_1 = __importDefault(require("./utils/progressBar"));
var VideoDownloader = /** @class */ (function () {
     ...
     */
    function VideoDownloader(url, logger) {
        this.url = url;
        this.logger = logger;
    }
    /**
     ...
     */
    VideoDownloader.prototype.stream = function (headers) {
        return __awaiter(this, void 0, void 0, function () {
            var stream;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request(headers)];
                    case 1:
                        stream = _a.sent();
                        return [2 /*return*/, stream.data];
                }
            });
        });
    };
     ...
     */
    VideoDownloader.prototype.download = function (filename, headers) {
        return __awaiter(this, void 0, void 0, function () {
            var stream, progressBar_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request(headers)];
                    case 1:
                        stream = _a.sent();
                        if (this.logger) {
                            progressBar_2 = new progressBar_1["default"](stream.headers['content-length'], 'Downloading', this.logger);
                            stream.data.on('data', function (chunk) {
                                progressBar_2.update(chunk.length);
                            });
                        }
    ...
    VideoDownloader.prototype.request = function (headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
